...
\pointnnc[fill=black,draw] {0.16608544}{0.78196448} % 1
\pointnnc[fill=black,draw] {-0.22178966}{0.38172358} % 2
\pointnnc[fill=black,draw] {-0.49853725}{0.76432549} % 3
...
\draw [cyan] (-0.85211632, 0.87482403) circle(0.03cm); % 45
...
%\draw [arrow,draw=red] (-0.93165719,0.88666088) --(-0.77257544,0.86298719); % 5-4
%\draw [arrow,draw=red] (-0.77257544,0.86298719) -- (-0.93165719,0.88666088); % 4-5
\draw [arrow,draw=red] (-0.85211632, 0.87482403) -- (-0.49853725,0.76432549); %45-3
\draw [arrow,draw=red] (-0.49853725,0.76432549) -- (-0.85211632, 0.87482403) ; %45-3
